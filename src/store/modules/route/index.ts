...
export const useRouteStore = defineStore('route-store', {
    ...
    actions: {
        ...
        async initDynamicRoute() {
            ...
            const {menu, user, btnAuths} = localStg.get('userInfo') || {};
            console.log("MARK-01")
            console.log(user)
            console.log(menu)
            ...
            const routeHome = 'status_running'

            this.routeHomeName = routeHome;
            this.handleUpdateRootRedirect(routeHome);
            this.handleAuthRoute(sortRoutes(menu));

            initHomeTab(routeHome, router);
